const about = [
  {
    ...
    social: [
      {
        network: 'github',
        link: 'https://github.com/EmilieVITAL',
        logo: 'fab fa-github',
      },
      {
        network: 'linkedin',
        link: 'https://www.linkedin.com/in/emilie-vital/',
  ...
  },
  {
    ...
    name: 'Geoffrey',
    pseudo: 'Spark',
    moto: 'Normalement ça marche.. Normalement.',
    dev: 'Back End',
    role: 'Lead dev Back',
  ...
  },
  {
    ...
    social: [
      {
        network: 'github',
        link: 'https://github.com/oliv-bernier',
        logo: 'fab fa-github',
      },
      {
        network: 'linkedin',
        link: 'https://www.linkedin.com/in/olivier-bernier/',
        logo: 'fab fa-linkedin',
      },
    ],
  },
  {
    ...
    social: [
      {
        network: 'github',
        link: 'https://github.com/FrancoisC-Marty',
        logo: 'fab fa-github',
      },
      {
        network: 'linkedin',
        link: 'https://www.linkedin.com/in/francoiscaus/',
        logo: 'fab fa-linkedin',
      },
    ],
  },
